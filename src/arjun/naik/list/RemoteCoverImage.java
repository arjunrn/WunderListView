...
public class RemoteCoverImage extends ImageView {
	...
	public RemoteCoverImage(Context context, AttributeSet attrs) {
		...
		defaultBookCover = context.getResources().getDrawable(
	...
	public void setLocalURI(String localURI) {
		...
		uriLocal = Environment.getExternalStorageDirectory()
				+ "/.remote-image-view-cache/" + last_file_name;
		imageLoaded = false;
	}
